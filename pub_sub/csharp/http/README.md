...
```bash
dapr run --app-id checkout --components-path pub_sub/components/ -- dotnet run --project pub_sub/csharp/http/checkout
```
...
```bash
dapr run --app-id order-processor --components-path pub_sub/components/ --app-port 7001 -- dotnet run --project pub_sub/csharp/http/order-processor
```
