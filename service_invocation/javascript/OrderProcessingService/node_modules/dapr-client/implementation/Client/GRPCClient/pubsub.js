...
var GRPCClientPubSub = /** @class */ (function () {
    function GRPCClientPubSub(client) {
        this.client = client;
    }
    // @todo: should return a specific typed Promise<TypePubSubPublishResponse> instead of Promise<any>
    GRPCClientPubSub.prototype.publish = function (pubSubName, topic, data) {
        if (data === void 0) { data = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var msgService;
            var _this = this;
            return __generator(this, function (_a) {
                msgService = new dapr_pb_1.PublishEventRequest();
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        client.publishEvent(msgService, function (err, res) {
                            if (err) {
                                return reject(err);
                            }
