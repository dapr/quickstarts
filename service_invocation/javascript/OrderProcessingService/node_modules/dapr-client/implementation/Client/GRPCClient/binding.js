...
var GRPCClientBinding = /** @class */ (function () {
    function GRPCClientBinding(client) {
        this.client = client;
    }
    ...
    GRPCClientBinding.prototype.send = function (bindingName, operation, data, metadata) {
        if (metadata === void 0) { metadata = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var msgService;
            var _this = this;
            return __generator(this, function (_a) {
                msgService = new dapr_pb_1.InvokeBindingRequest();
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        client.invokeBinding(msgService, function (err, res) {
                            if (err) {
                                return reject(err);
                            }
