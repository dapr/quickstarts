...
var HTTPServerBinding = /** @class */ (function () {
    function HTTPServerBinding(server, client) {
        this.client = client;
        this.server = server;
    }
    // Receive an input from an external system
    HTTPServerBinding.prototype.receive = function (bindingName, cb) {
        return __awaiter(this, void 0, void 0, function () {
            var server;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.server.getServer()];
                    case 1:
                        server = _a.sent();
                        server.options("/" + bindingName, function (req, res) {
                            return res.end();
                        });
