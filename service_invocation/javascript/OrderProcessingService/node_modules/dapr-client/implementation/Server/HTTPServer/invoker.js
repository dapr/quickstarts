...
var HTTPServerInvoker = /** @class */ (function () {
    function HTTPServerInvoker(server, client) {
        this.client = client;
        this.server = server;
    }
    HTTPServerInvoker.prototype.listen = function (methodName, cb, options) {
        var _a;
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var serverMethod, server;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.server.getServer()];
                    case 1:
                        server = _b.sent();
                        // @TODO should pass rest of headers to callback
                        server[serverMethod]("/" + methodName, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                            var invokeResponse;
                                ...
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        if (!res.writableEnded) {
                                            if (invokeResponse) {
                                                return [2 /*return*/, res.end(JSON.stringify(invokeResponse))];
                                            }
                                            else {
                                                return [2 /*return*/, res.end(JSON.stringify({ closed: true }))];
                                            }
                                        }
                                        return [2 /*return*/];
                                }
    ...
    return HTTPServerInvoker;
}());
exports.default = HTTPServerInvoker;
