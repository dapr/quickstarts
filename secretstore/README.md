...
Once you have a cluster, follow the steps below to deploy Dapr to it. For more details, look [here](https://docs.dapr.io/operations/hosting/kubernetes/kubernetes-deploy/).
