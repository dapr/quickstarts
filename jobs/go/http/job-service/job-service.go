...
// 	// Handles the job scheduler request
// 	r.HandleFunc("/job/", handleScheduledJob).Methods("POST")

// 	// Handles the get job request
// 	r.HandleFunc("/jobs/", handleGetJob).Methods("GET")

// 	// Handles the delete job request
// 	r.HandleFunc("/jobs/", handleDeleteJob).Methods("DELETE")
